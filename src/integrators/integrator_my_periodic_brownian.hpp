 ...
 * \date 07-Apr-2020
 * \brief Declaration of IntegratorMyPeriodicBrownian class
 */ 

#ifndef __INTEGRATOR_MY_PERIODIC_BROWNIAN_H__
#define __INTEGRATOR_MY_PERIODIC_BROWNIAN_H__
...
/*! IntegratorMyPeriodicBrownian class handles my periodic Brownian dynamics.
*/
class IntegratorMyPeriodicBrownian : public Integrator
{
public:
  ...
  IntegratorMyPeriodicBrownian(SystemPtr sys, MessengerPtr msg, PotentialPtr pot, AlignerPtr align, NeighbourListPtr nlist,  ConstrainerPtr cons, ValuePtr temp, pairs_type& param) : Integrator(sys, msg, pot, align, nlist, cons, temp, param)
  { 
...
typedef shared_ptr<IntegratorMyPeriodicBrownian> IntegratorMyPeriodicBrownianPtr;
